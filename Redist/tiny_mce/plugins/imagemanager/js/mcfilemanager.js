var mcFileManager = {
	...
	open : function(form_name, element_names, file_url, js, s) {
		...
		if (s.iframe) {
			...
			win.contentWindow.document.location = this.getBaseURL() + '/../default.aspx?type=fm';
			return;
		} else
			win = window.open(this.getBaseURL() + '/../default.aspx?type=fm' + pa, 'mcFileManagerWin', 'left=' + x + ',top=' + y + ',width=' + w + ',height=' + h + ',scrollbars=yes,resizable=yes,statusbar=no');
