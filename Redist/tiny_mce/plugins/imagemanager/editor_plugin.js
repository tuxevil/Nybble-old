	...
	var TinyMCE_ImageManagerPlugin = {
		...
		_init2x : function() {
			...
			if (!window['realTinyMCE'])
				this._loadScript(tm.baseURL + '/plugins/imagemanager/language/default.aspx?type=im&format=tinymce&group=tinymce&prefix=imagemanager_');
		...
		_init3x : function() {
			...
			tinymce.ScriptLoader.load(tinymce.baseURL + '/plugins/imagemanager/language/default.aspx?type=im&format=tinymce_3_x&group=tinymce&prefix=imagemanager_');
